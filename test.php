...
<html>
  ...
  <body class="standard" style="background-color:white;">
    <div class="main container">
      <h1>Easy Password Protection</h1>


<video src="http://yme2.nitai.no/rc_images/small.mp4" controls="controls" width="300" height="150">Your browser does not support the video element.</video>
...
?&gt;</code></pre>
      ...
      <p>&nbsp;</p>
      <a href="test2.php">Test Seite # 2</a>
      <hr>
